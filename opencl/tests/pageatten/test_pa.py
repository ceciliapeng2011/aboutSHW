...
if __name__ == "__main__":
    ...
    test_page_attn_causal_batch1(8225, num_heads = 1, num_kv_heads = 1, head_size = 32, block_sz=48, trunk_sz=1200, compressed_kvcache=False, sparse_block_sz = 1, check_acc=True)
    #ACC test PA base
    if 0:
